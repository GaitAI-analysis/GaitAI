...
> Historical publication verification. The authoritative current source audit is [the 92-file coverage report](product-image-coverage.md). Its source selections supersede the inventory counts below; this document preserves what was previously deployed and tested.
