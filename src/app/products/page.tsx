        ...
        <div className="container-wide">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-8 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.03] p-1.5">
              <Link
                href="/mobilitycare"
                className="inline-flex items-center rounded-full bg-teal-300/10 px-4 py-1.5 text-xs font-semibold text-teal-300 transition-colors hover:bg-teal-300/15"
              >
                MobilityCare · {mobilityProducts.length}
              </Link>
              <Link
                href="/securevision"
                className="inline-flex items-center rounded-full bg-royal-300/10 px-4 py-1.5 text-xs font-semibold text-royal-300 transition-colors hover:bg-royal-300/15"
              >
