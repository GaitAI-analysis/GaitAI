...
const STAGES = [
  {
    ...
    why: "A walking clip is the input. The prepared example explains the capture step; camera position, lighting, visibility and permission to record still matter in a real workflow.",
  },
  {
    n: "02",
    id: "pose",
    ...
    why: "The illustrated joints replace appearance with body structure. They are drawn from shared gait keyframes, not detected from an uploaded video in this walkthrough.",
  },
  {
    n: "03",
    id: "measure",
    ...
    why: "The highlighted parts of a stride explain the relationship between motion and a feature. These are illustrative readings; the browser analyzer separately reports only signals it can compute.",
  },
  {
    n: "04",
    id: "interpret",
    ...
    why: "The example compares a walk with a hypothetical earlier baseline. A real longitudinal conclusion needs comparable recordings, validation and a reviewer who understands the context.",
  },
  {
    n: "05",
    id: "act",
    ...
    why: "The output organizes movement observations for human review. No diagnostic conclusion, identity claim or safety guarantee is generated by this demonstration.",
  },
] as const;
          ...
          <div className={styles.scrim} onClick={close} role="presentation">
            ...
            >
              ...
              <header className={styles.head}>
                <div className={styles.headText}>
                  ...
                  <h2 id="try-gaitai-title" className={styles.title}>
                    Experience Movement Intelligence
                  </h2>
                </div>
              ...
              <div className={styles.entryActions}>
                <Link href="/movement-lab?demo=mobility-walk#analyze" onClick={close}>Use demo walk <span aria-hidden="true">→</span></Link>
                <Link href="/movement-lab?source=upload#analyze" onClick={close}>Upload walking video <span aria-hidden="true">→</span></Link>
                <p>Or explore the illustrative pipeline below.</p>
              </div>
              ...
              >
                ...
                <details className={styles.explainStage}>
                  <summary>Why is this stage shown?</summary>
                  <p>{current.why}</p>
                </details>
              </div>
