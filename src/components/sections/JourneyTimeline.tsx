...
const journey: Milestone[] = [
  {
    ...
    desc: "Founder-led research begins around human gait analysis, including Parkinsonian gait and movement-related disorders. The foundational idea: walking carries measurable signals about mobility and movement patterns.",
    icon: Brain,
    accent: "violet",
  },
  {
    ...
    desc: "The research expands into gait recognition for surveillance and security applications, studying gait as a non-contact biometric signal under varied conditions.",
    icon: ShieldCheck,
    accent: "blue",
  },
  {
    year: "Research portfolio",
    title: "Patents · Papers · Research",
    desc: "Years of study and scientific exploration grew into a portfolio of peer-reviewed publications and patents across gait recognition, biometric movement analysis and applied AI.",
    icon: BookOpen,
    accent: "cyan",
  },
  {
    ...
    desc: "MobilityCare and SecureVision organize specialized modules around one movement-intelligence platform built on a decade of founder-led research.",
    icon: Sparkles,
    accent: "gold",
  },
];
