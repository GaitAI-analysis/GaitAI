...
import { ResearchRecordDisclosure } from "./ResearchRecordDisclosure";
 ...
 * the same link `data/search-index.ts` emits for a research area. An area
 * whose entire record is a single patent goes one better and links to that
 * patent's own record page, because there the record IS the destination and a
 * filter over one row is a worse answer than the row.
 */
  ...
  return (
    ...
    >
      ...
      <div className="container-wide">
        ...
        {/* ── The record itself, behind one row ──────────────────────────
            The diagram and the sentence above it are the section's argument;
            everything below is the detail that backs it, and a reader who
            wants it asks for it. Nothing here is cut, summarised or moved to
            another page — it is the same markup, in the same order, inside a
            panel that starts closed. */}
        <ResearchRecordDisclosure>
          {/* Founder research record — explicitly attributed */}
          <Reveal>
            <div
              id="research-founder-record"
              className="site-anchor-offset res-record-block mt-14"
            >
          ...
          <Reveal>
            <div
              ...
              className="site-anchor-offset mt-14 border-t border-white/[0.06]"
            >
          ...
          <div className="mt-12 grid gap-4 lg:grid-cols-2">
            <div
              ...
              className="site-anchor-offset res-decision res-decision--cyan"
            >
              <EvidenceChainMotif />
            ...
            <div
              id="research-privacy-by-design"
              className="site-anchor-offset res-decision res-decision--emerald"
            >
              <PrivacyLayerMotif />
              <div className="res-decision-body">
          ...
          <div
            id="research-responsible-deployment"
            className="site-anchor-offset mt-10 rounded-2xl border border-white/[0.06] bg-white/[0.02] p-5 sm:p-6"
          >
