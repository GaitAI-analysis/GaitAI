...
// MobilityCare-only hero scene — frozen at commit e28f465 (the state immediately
// before the Home walking-gait animation). Deliberately NOT shared with the Home
// hero: changes to the animated Home HeroScene must never propagate here.
...
export default function MobilityHeroScene() {
  return (
    <Canvas
