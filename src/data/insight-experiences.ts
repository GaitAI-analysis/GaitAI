  ...
  "can-a-skeleton-still-reveal-identity": {
    ...
    links: {
      ...
      gaitscape: [
        ...
        { label: "AccessMotion — a consistency signal beside a credential", node: "accessmotion" },
      ],
      ask: true,
    },
  },
  ...
  "a-good-model-can-still-be-a-bad-system": {
    ...
    links: {
      gaitscape: [
        ...
        { label: "SuspiciousMotion — one chain across an installation", node: "suspiciousmotion" },
      ],
      ask: true,
    },
  },
  ...
  "what-is-a-personal-movement-baseline": {
    ...
    links: {
      ...
      gaitscape: [
        ...
        { label: "Temporal modelling", node: "cap-temporal" },
        { label: "Rehabilitation progress", node: "sig-rehab-progress" },
        { label: "RehabTrack — personal baselines across a programme", node: "rehabtrack" },
      ],
