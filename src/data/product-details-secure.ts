  ...
  // ==========================================================================
  {
    ...
    tech: {
      ...
      limitations: [
        ...
        "Not designed for autonomous targeting, weapons integration, adversary tracking or lethal decision-making",
    ...
    modes: [
      {
        ...
        name: "Army",
        summary:
          "Land installations, training areas and depots. Personnel movement and readiness assessment, training-related movement change, load-carriage movement analysis, rehabilitation and return-to-duty tracking, facility safety, and authorised secure access — one configuration of the same platform.",
        focus: [
          "Personnel movement and readiness assessment against each person's own baseline",
          "Training-related movement change over a programme (illustrative indicators)",
          "Load-carriage movement analysis: how gait changes under load, read as movement, never as a fitness verdict",
          "Rehabilitation and return-to-duty movement tracking for unit medical teams",
          "Facility safety: falls and restricted-zone events across training areas and depots",
          "Authorised secure access: a gait-consistency indicator beside existing credentials",
        ],
      },
      {
        id: "navy",
        name: "Navy",
        summary:
          "Shore establishments, dockyards and vessel spaces. Balance and stability, movement in constrained and dynamic environments, slip and fall safety, rehabilitation, personnel mobility monitoring, and authorised ship and base access.",
        focus: [
          "Balance and stability indicators from routine movement",
          "Movement in constrained and dynamic environments: corridors, gangways, ladders and decks",
          "Slip and fall safety events for safety teams",
          "Rehabilitation and recovery trends after injury",
          "Personnel mobility monitoring for enrolled, consenting personnel",
          "Authorised ship and base access: a consistency signal beside existing credentials",
        ],
      },
      {
        id: "airforce",
        name: "Air Force",
        summary:
          "Air bases, aprons and hangars. Ground-personnel mobility and safety, repetitive-workload and fatigue-related movement change, rehabilitation, facility safety, and authorised secure access at controlled technical areas.",
        focus: [
          "Ground-personnel mobility and safety on aprons and in hangars",
          "Repetitive-workload and fatigue-related movement change, read against a personal baseline",
          "Rehabilitation and return-to-duty movement tracking",
          "Facility safety: movement events in hangars and controlled technical areas",
          "Authorised secure access at controlled areas",
          "Decision support for medical, safety and access teams — human review throughout",
        ],
      },
    ],
    privacy:
