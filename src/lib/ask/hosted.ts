 ...
 * and calls a hosted model through Cloudflare Workers AI — the Worker's own
 * `AI` binding, so there is no provider key anywhere: not in this bundle, not
 * in a NEXT_PUBLIC_ variable, not in the repository, not in a response.
 *
